<?
   ...
   switch ($tipo_cod) {
      ...
      case 1:
         ...
         $Log->RegistraLinea('ADM: SE ELIMINO SERVICO "Botón de emergencia SIP - Móvil" A USUARIO | BUSUA_COD: ' . ($Usuario->busua_cod));
      ...
      case 2:
         ...
         $path_log = Parameters::PATH . '/log/site_adm.log';
         $Log->CreaLogTexto($path_log);
         $Log->RegistraLinea('ADM: SE ELIMINO SERVICO "Servicio Botón de emergencia SIP - Estático" A USUARIO | BUSUA_COD: ' . ($Usuario->busua_cod));
      ...
      case 5:
         ...
         $path_log = Parameters::PATH . '/log/site_adm.log';
         $Log->CreaLogTexto($path_log);
         $Log->RegistraLinea('ADM: SE ELIMINO SERVICO "Tracker" A USUARIO | BUSUA_COD: ' . ($Usuario->busua_cod) . ' | TIPO_COD: ' . ($tipo_cod));
