...
<html lang="es">
   <head>
      ...
      <!-- title -->
      <title>Cambio de contrase&ntilde;a · Prot&eacute;geme</title>
      <meta name="title" content="Cambio de contrase&ntilde;a Protegeme">
         ...
         <div class="container">
            ...
            <div class="row justify-content-center">
               <div class="col-12 div-form-login border p-3">
                  ...
                  <form id="form-reset-password" class="row needs-validation">
                     ...
                     <div class="col-12 mb-3">
                        <button type="submit" class="btn btn-sm btn-danger w-100" id="btn-recovery-up-login" name="btn-recovery-up-login"> 
                           <div id="spinner-btn-recovery-up-login" class="spinner-border spinner-border-sm text-white" role="status" hidden>
                              <span class="visually-hidden">Loading...</span>
                           </div>
                           <span id="textbtn-btn-recovery-up-login">Cambiar contrase&ntilde;a</span>
                        </button>
                     </div>
      ...
      <script type="text/javascript">
         document.addEventListener('DOMContentLoaded', function(event) {
            document.getElementById('form-reset-password').addEventListener('submit', async e => {
               ...
               await spinnerOpenBtn('btn-recovery-up-login', '');
               const data = await validateFormPasswordReset();
               const result = await resetPasswordUser(data);
               await spinnerCloseBtn('btn-recovery-up-login', 'Cambiar contrase&ntilde;a');
                  ...
                  <setcion id="modal-user-rv">
                     <div class="container-fluid">
                        ...
                        <div class="row">
                           ...
                           <div class="col-12 d-flex justify-content-center mb-3">
                              <a type="button" class="btn btn-sm btn-danger w-100" id="home" name="home" href="${url}/login/index.php">Ir al inicio</a>
                           </div>
                        </div>
                     </div>
                  </setcion>
