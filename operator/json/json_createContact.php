...
Mas informacion en www.protegeme.cl';
      ...
      $desc = 'NUEVO CONTACTO CREADO | USUA_COD: ' . $Usuario->busua_cod . ' | NÚMERO CONTACTO: ' . $numero . ' | NOMBRE CONTACTO: ' . (strlen($nombre) === 0 ? 'NO REGISTRA' : $nombre) . ' | LLAMADAS: ' . ($call === true ? 'SI' : 'NO') . ' | SMS: ' . ($sms === true ? 'SI' : 'NO');
      $Log->inserta($Operador->oper_cod, $desc, 'operator/json/json_createContact.php', $DB);
