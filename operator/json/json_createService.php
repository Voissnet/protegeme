<?
   ...
   switch ($tipo_cod) {
      ...
      case 1:
         ...
         $desc = 'SE AGREGO SERVICIO "Servicio creado Botón de emergencia SIP - Móvil" A USUARIO | BUSUA_COD: ' . ($busua_cod) . ' | TIPO_COD: ' . (1);
         $Log->inserta($Operador->oper_cod, $desc, 'operator/json/json_createUser.php', $DB);
      ...
      case 2 :
         ...
         $desc = 'SE AGREGO SERVICIO "Servicio creado Botón de emergencia SIP - Estático" A USUARIO | BUSUA_COD: ' . ($busua_cod) . ' | TIPO_COD: ' . (2);
         $Log->inserta($Operador->oper_cod, $desc, 'operator/json/json_createUser.php', $DB);
