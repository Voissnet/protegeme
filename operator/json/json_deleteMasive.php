<?
   ...
   for ($i = 0; $i < count($users); $i++) { 
      ...
      $desc = 'USUARIO ELIMINADO | BUSUA_COD: ' . ($Usuario->busua_cod) . ' | DOM_COD: ' . ($Dominio->dom_cod)  . ' | GROUP_COD: ' . ($Usuario->group_cod);
      $Log->inserta($Operador->oper_cod, $desc, 'operator/json/json_deleteMasive.php', $DB);
