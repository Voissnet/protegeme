...
result:
   if ($error === true) {
      ...
      $desc = 'SMS PARA CONTACTO | BUSUA_COD: ' . $Usuario->busua_cod . ' | NÚMERO CONTACTO: ' . $numero . ' | SMS: ' . ($check === true ? 'SI' : 'NO');
      $Log->inserta($Operador->oper_cod, $desc, 'operator/json/json_updateContactSMS.php', $DB);
