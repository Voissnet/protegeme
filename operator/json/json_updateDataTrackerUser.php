...
result:
   if ($error === true) {
      ...
      $desc = 'DATOS DEL TRACKER MODIFICADOS | BUSUA_COD: ' . $Usuario->busua_cod . ' | NUEVO TIPO TRACKER: ' . $tipo_cod . ' | DESC_TIPO: ' . $Tipo->tipo_servicio  . ' | NUEVA CAUSA: ' . $causa;
      $Log->inserta($Operador->oper_cod, $desc, 'operator/json/json_updateDataTrackerUser.php', $DB);
