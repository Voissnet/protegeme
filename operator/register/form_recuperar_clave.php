...
?>
   ...
   <html lang="es">
      <head>
         ...
         <!-- title -->
         <title>Recuperar contrase&ntilde;a · Prot&eacute;geme operador</title>
         <meta name="title" content="Recovery password Protegeme Operador">
      ...
      <body>
            ...
            <div class="container">
               ...
               <div class="row justify-content-center">
                  <div class="col-12 div-form-login border p-3">
                     ...
                     <form id="form-recovery-operator" class="row" name="form" autocomplete="off">
                        ...
                        <div class="col-12 mb-3">
                           <button type="submit" class="btn btn-sm btn-danger w-100" id="btn-recovery-login-operator" name="btn-recovery-login-operator"> 
                              <div id="spinner-btn-recovery-login-operator" class="spinner-border spinner-border-sm text-white" role="status" hidden>
                                 <span class="visually-hidden">Loading...</span>
                              </div>
                              <span id="textbtn-btn-recovery-login-operator">Obtener correo de recuperaci&oacute;n</span>
                           </button>
                        </div>
                        <div class="col-12 mb-3">
                           <a href="<?= Parameters::WEB_PATH ?>/operator/login/index.php" class="text-decoration-none btn-perso">Volver al inicio</a>
                        </div>
         ...
         <script type="text/javascript">
            document.getElementById('form-recovery-operator').addEventListener('submit', async e => {
               try {
                  e.preventDefault();
                  let text_error = document.getElementById('r-error');
                  text_error.classList.add('d-none');
                  await spinnerOpenBtn('btn-recovery-login-operator', '');
                  const data = await validateFormLoginAdm();
                  const result = await validateFormRecuPasswordOper(data);
                     ...
                     <setcion id="modal-user-rv">
                        <div class="container-fluid">
                           ...
                           <div class="row">
                              ...
                              <div class="col-12 d-flex justify-content-center mb-3">
                                 <a type="button" class="btn btn-sm btn-danger w-100" id="home" name="home" href="${url_operator}/login/index.php">Volver al inicio</a>
                              </div>
                           </div>
                        </div>
                     </setcion>
                  ...
                  await spinnerCloseBtn('btn-recovery-login-operator', 'Obtener correo de recuperaci&oacute;n');
               } catch (error) {
                  await spinnerCloseBtn('btn-recovery-login-operator', 'Obtener correo de recuperaci&oacute;n');
