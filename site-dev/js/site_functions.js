...
import { openEmergency } from './site_module.js?40';              // acciona boton de emergencia
import { openSettings } from './site_module.js?40';               // acciona boton de configuraciones
import { closeContacts } from './site_module.js?40';              // cierra menu de contactos
import { clearHistory } from './site_module.js?40';               // limpia historial
import { spinnerContacts } from './site_module.js?40';            // spinner de carga
import { dataContacts } from './site_module.js?40';               // muestra informacion de contactos de llamadas
import { onlyNumbers } from './site_module.js?40';                // admite solo numeros
import { largeInput } from './site_module.js?40';                 // valida digito ingresado
import { localStorageSave } from './site_module.js?40';           // guarda un dato en el localstorage
import { createContact } from './site_module.js?40';              // agrega un contacto de emergencia llamadas
import { getLocationGPS } from './site_module.js?40';             // location
import { reserTimeOut } from './site_module.js?40';               // refresca tiempo del modal
