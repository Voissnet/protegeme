<?
   ...
   $Log->RegistraLinea(($device === 'APP' ? 'APP' : 'WEB') . ': NOMBRE CONTACTO MODIFICADO | BUSUA_COD: ' . ($Usuario->busua_cod) . ' | NÚMERO CONTACTO: ' . ('56' . $numero) . ' | NUEVO NOMBRE CONTACTO: ' . (strlen($nombre) === 0 ? 'NO REGISTRA' : $nombre));
